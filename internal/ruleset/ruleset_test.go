...
func TestParse_Errors(t *testing.T) {
	cases := map[string]string{
		...
		"unknown playerAttribute type": `{"name":"x","ruleLanguageVersion":"1.0",
		  "playerAttributes":[{"name":"skill","type":"float"}],
		  "teams":[{"name":"r","minPlayers":1,"maxPlayers":2}]}`,
		"team maxPlayers must be positive": `{"name":"x","ruleLanguageVersion":"1.0",
		  "teams":[{"name":"r","minPlayers":0,"maxPlayers":0}]}`,
		"team minPlayers exceeds maxPlayers": `{"name":"x","ruleLanguageVersion":"1.0",
		  "teams":[{"name":"r","minPlayers":5,"maxPlayers":2}]}`,
		"unknown algorithm strategy": `{"name":"x","ruleLanguageVersion":"1.0","algorithm":{"strategy":"genetic"},
		  "teams":[{"name":"r","minPlayers":1,"maxPlayers":2}]}`,
		"unknown backfillPriority": `{"name":"x","ruleLanguageVersion":"1.0","algorithm":{"backfillPriority":"urgent"},
		  "teams":[{"name":"r","minPlayers":1,"maxPlayers":2}]}`,
		"balancedAttribute not declared": `{"name":"x","ruleLanguageVersion":"1.0",
		  "algorithm":{"strategy":"balanced","balancedAttribute":"skill"},
		  "teams":[{"name":"r","minPlayers":1,"maxPlayers":2}]}`,
		"balancedAttribute not a number": `{"name":"x","ruleLanguageVersion":"1.0",
		  "playerAttributes":[{"name":"tier","type":"string"}],
		  "algorithm":{"strategy":"balanced","balancedAttribute":"tier"},
		  "teams":[{"name":"r","minPlayers":1,"maxPlayers":2}]}`,
	}
